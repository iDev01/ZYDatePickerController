...
- (IBAction)chooseDateButtonClicked:(id)sender {
    ...
    ZYDatePickerController *datePickController = [[ZYDatePickerController alloc] initWithMessage:NSLocalizedString(@"pleaseChooseDate", nil) mode:UIDatePickerModeDateAndTime dateFormat:@"yyyy-MM-dd" handler:^(NSString *dateString) {
